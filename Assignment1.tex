...
\begin{boxxed}
\textcolor{CB_blue}{
We, \textbf{\textit{<Roni Nahum>}}, ID number \textbf{\textit{<212978761>}}, and \textbf{\textit{<Insert your name>}}, ID number \textbf{\textit{<Insert your ID>}} assert that the work we submitted is entirely our own.
...
\begin{itemize}
    \item  $f_{1} \in \ \Theta(f_{2}):$
      \begin{itemize}
         ...
         \item $f_{1} \in \ \Omega(f_{2}): \ 1 \geq c(1034)$ for $n \ge n_0 =1$ and $c=\frac{1}{1034}$.
    \item $f_{1} \in \ O(f_{9}): \ 1 \leq c(log(n^\frac{1}{3})))$ for every $n \ge n_0 = 2$ and $c=3$.
...
We must verify $f(n) \in \BigO{n^{\log_b a - \varepsilon}}$ for some $\varepsilon > 0$.
...
Therefore $f(n) \in \BigO{n^2}$, and by the Master Theorem:
\[
    \boxed{T(n) \in \BigTh{n^2}}
\]
...
We must verify $f(n) \in \BigTh{n^{\log_b a}}$:
\[
    f(n) = 1 \in \BigTh{1} \qquad \text{for } c > 1,\ n_0 > 1 \quad\checkmark
\]

Therefore, by the Master Theorem:
\[
    \boxed{T(n) \in \BigTh{\log n}}
\]
...
We must verify $f(n) \in \BigOm{n^{\log_b a + \varepsilon}}$ for some $\varepsilon > 0$.
Take $\varepsilon = 1$:
\[
...
\[
    T(n) = \Theta(f(n)) = \Theta(n^4 \log n) \quad \checkmark
\]
...
\begin{tabular}{||c | c | c | c ||} 
 ...
 \hline
  14 & $\Theta(1)$ & $\Theta(n^2)$ & $\Theta(n^2)$\\  
 \hline
 15 & \cellcolor{Gray} & \cellcolor{Gray} & \cellcolor{Gray} \\ 
 \hline
 16  & $\Theta(1)$ & $\Theta(n^2)$ & $\Theta(n^2)$\\  
 \hline
